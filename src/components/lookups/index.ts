// Barrel re-export for the lookups admin module. Other code only needs the
// panel; the individual editors are wired internally by LookupsPanel.

export { default as LookupsPanel } from './LookupsPanel';
